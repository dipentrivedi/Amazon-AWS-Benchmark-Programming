...
public class Module1CPU extends Thread {
	...
	//threads=s.nextInt();
	Module1CPU[] t1=new Module1CPU[threads];
	flag = 'i';
	...
	double giops1= ((iteration*1000*20*5)/(estimatedTime));
	double giops= (giops1/1000000000);
	
	System.out.println("GIOPS : "+giops);

	Module1CPU[] t2=new Module1CPU[threads];
	flag='f';
	...
	double flops1= ((iteration*1000*20*5)/(estimatedTime1));
